...
STRIPE_AWESOME_REMOVE_ADS_PRICE_ID = env("STRIPE_AWESOME_REMOVE_ADS_PRICE_ID", default="")
...
OPENROUTER_APP_TITLE = env("OPENROUTER_APP_TITLE", default="Awesome")
OPENROUTER_APP_CATEGORIES = env("OPENROUTER_APP_CATEGORIES", default="programming-app")
...
GITHUB_REPOSITORY_SYNC_USE_USER_TOKENS = env.bool(
    "GITHUB_REPOSITORY_SYNC_USE_USER_TOKENS",
    default=True,
)
